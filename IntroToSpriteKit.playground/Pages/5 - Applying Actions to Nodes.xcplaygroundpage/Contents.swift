...
let actionLongerWait20secondsThenMoveRight = SKAction.sequence([actionFiveSecondWait, actionFiveSecondWait, actionFiveSecondWait, actionFiveSecondWait, actionRightMovement])

circle1.run(actionLongerWait20secondsThenMoveRight)


// Exercise 2: Write your code below.

let actionWait20SeondsThenMoveUpAndLeft = SKAction.sequence([actionFiveSecondWait, actionFiveSecondWait, actionFiveSecondWait, actionFiveSecondWait, actionRightMovement, actionUpwardsMovement])

circle2.run(actionWait20SeondsThenMoveUpAndLeft)



// Exercise 3: Write your code below.

let actionMoveUpAndRight = SKAction.sequence([actionRightMovement, actionUpwardsMovement, actionRightMovement, actionUpwardsMovement])
    repeat 10

circle1.run(actionMoveUpAndRight)
